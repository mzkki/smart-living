    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="overflow-hidden rounded-xl border border-sidebar-border/70 bg-white shadow-sm dark:border-sidebar-border dark:bg-gray-800">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        className={`inline-flex rounded-full px-2 text-xs leading-5 font-semibold ${
                                                            kosan.status === 'Tersedia' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                                                        }`}
                                                    >
                                                        {kosan.status}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4 text-sm whitespace-nowrap text-gray-500">{kosan.featured ? 'Yes' : 'No'}</td>
                                                <td className="px-6 py-4 text-sm font-medium whitespace-nowrap">
                                                    <Link href={route('kosans.show', kosan.id)} className="mr-4 text-blue-600 hover:text-blue-900">
                                                        View
                                                    </Link>
                                                    <Link
